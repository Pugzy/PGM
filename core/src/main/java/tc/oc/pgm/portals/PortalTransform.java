...
public interface PortalTransform extends InvertibleOperator<PortalTransform> {
    ...
    static PortalTransform piecewise(DoubleProvider x, DoubleProvider y, DoubleProvider z, DoubleProvider yaw, DoubleProvider pitch) {
    ...
    class Piecewise implements PortalTransform {
        ...
        private Piecewise(DoubleProvider x, DoubleProvider y, DoubleProvider z, DoubleProvider yaw, DoubleProvider pitch) {
            this.x = x;
            this.y = y;
            this.z = z;
            this.yaw = yaw;
